...
products = {
    'veg_pickles': [
        {'id': 1, 'name': 'Mango Pickle', 'price': 150, 'description': 'Raw mango chunks in fiery red chili-garlic masala.', 'image': 'mango_pickle.jpg'},
    ...
    'non_veg_pickles': [
        {'id': 6, 'name': 'Chicken Pickle', 'price': 200, 'description': 'Juicy, tender chicken cooked to perfection.', 'image': 'Chicken_pickle.jpg'},
        {'id': 7, 'name': 'Mutton Pickle', 'price': 300, 'description': 'Mutton pickle with bold and spicy flavor.', 'image': 'mutton_pickle.jpg'},
        {'id': 8, 'name': 'Fish Pickle', 'price': 250, 'description': 'A coastal delicacy made with premium fish.', 'image': 'fish.jpg'},
        {'id': 9, 'name': 'Prawn Pickle', 'price': 250, 'description': 'Succulent prawns infused with mustard and chili.', 'image': 'prawn_pickle.jpg'},
        {'id': 10, 'name': 'Chicken Gongura Pickle', 'price': 210, 'description': 'Succulent Chicken Gongura Bites.', 'image': 'chicken_gongura.jpg'},
        {'id': 11, 'name': 'Mutton Gongura Pickle', 'price': 210, 'description': 'Where mutton meets gongura magic.', 'image': 'Gongora_mutton.jpg'}
    ],
    'snacks': [
        {'id': 12, 'name': 'Masala chat', 'price': 80, 'description': 'Masala chaat is a spicy and tangy Indian street food bursting with bold flavors.', 'image': 'masala_chat.jpg'},
        {'id': 13, 'name': 'Samosa', 'price': 70, 'description': 'Golden crispy gram flour pearls seasoned with bold flavors.', 'image': 'Samosa.jpg'},
        {'id': 14, 'name': 'Popcorn', 'price': 30, 'description': 'Melt-in-your-mouth buttery goodness with every pop!', 'image': 'popcorn.jpg'},
        {'id': 15, 'name': 'Chips', 'price': 60, 'description': 'Your favorite snack, now with extra crunch and flavor!', 'image': 'chips.jpg'},
        {'id': 16, 'name': 'French Fries', 'price': 80, 'description': 'French fries are crispy, golden potato sticks loved around the world.', 'image': 'French_fries.jpg'},
